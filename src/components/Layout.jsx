  ...
  return (
    ...
    >
      ...
      <div className="relative flex basis-0 justify-end space-x-6 sm:space-x-8 md:flex-grow">
        ...
        <Link href="https://github.com/Impalatore">
          <a className="group">
      ...
      <div className="relative mx-auto flex max-w-8xl justify-center sm:px-2 lg:px-8 xl:px-12">
        <div className="hidden lg:relative lg:block lg:flex-none">
          ...
          <div className="sticky top-[4.5rem] -ml-0.5 h-[calc(100vh-4.5rem)] overflow-y-auto py-16 pl-0.5">
            ...
            <div className="absolute top-28 bottom-0 right-0 hidden w-px bg-neutral-900 dark:block" />
            <Navigation
          ...
          <article>
            {(title || section) && (
              <header className="mb-9 space-y-1">
                {section && (
                  <p className="font-display text-sm font-medium text-amber-400">
                    {section.title}
                  </p>
                )}
                {title && (
